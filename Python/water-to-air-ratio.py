...
# -*- coding: utf-8 -*-
"""
Created on Mon May 20 22:18:33 2024
...
stopping_power_ratio = normalized_stopping_power_water / interpolated_stopping_power_air 

# Plotting
plt.figure(figsize=(10, 6))

# Plotting the air-to-water stopping power ratio
plt.plot(energy_water, stopping_power_ratio, label='Water-to-Air Stopping Power Ratio')

plt.title('Water-to-Air Stopping Power Ratio')
plt.xlabel('Energy (MeV)')
plt.ylabel('Stopping Power Ratio')

# Set the x-axis limits to 0 MeV and 2500 MeV
plt.xlim(0, 2500)
